...
AGENT_SUFFIX = (
    "\n\n당신은 도구를 사용할 수 있습니다."
    " 위협·선박·OSINT·활동량에 대한 질의에는 반드시 조회 도구(get_threats, get_threat_evidence, get_osint, get_timeline)로"
    " 실데이터를 확인한 뒤 근거 항목을 인용해 답하고, 조회 없이 수치나 현황을 단정하지 마세요."
    " 화면 이동·표시 변경 요청에는 화면 조작 도구를 호출하세요."
    " 분석관이 특정 위협의 확인 결과(위협 아님, 위험 상향 등)를 보고하면 assess_threat 도구로 조정 인자를 기록하세요."
    " 도구 실행 결과는 시스템이 자동 반영합니다."
)
